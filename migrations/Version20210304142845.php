 ...
 */
final class Version20210304142845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__invoice AS SELECT id, recipient FROM invoice');
        ...
        $this->addSql('INSERT INTO invoice (id, recipient) SELECT id, recipient FROM __temp__invoice');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__invoice AS SELECT id, recipient FROM invoice');
        $this->addSql('DROP TABLE invoice');
        $this->addSql('CREATE TABLE invoice (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, recipient VARCHAR(255) NOT NULL, supplier VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO invoice (id, recipient) SELECT id, recipient FROM __temp__invoice');
        $this->addSql('DROP TABLE __temp__invoice');
        $this->addSql('DROP INDEX IDX_5904BEAD2989F1FD');
        $this->addSql('DROP INDEX IDX_5904BEADDD842E46');
